...
1. $\frac{5}{(-7)}- 2/(3+a)$
2. $\frac{\frac{4a}{b}}{\frac{b}{c}}$

Ophæv følgende parenteser:

3. [@3] $(5b+a)^2$
4. $\left( 1+ \frac{a}{b} \right) \left( 1 + a \right)$
5. $\left( \frac{b}{a}- \frac{a}{b} \right)^2$

Udvid følgende logaritmeudtryk:

6. [@6] $\log \left( x\cdot y \right)$
7. $\log \left( \frac{3 \cdot x^{1.5}}{y} \right)$
